...
new class extends Component {
    ...
    public function updateProfileInformation(): void
    {
        ...
        $this->dispatch('profile-updated', message: 'Profil berhasil diperbarui!', type: 'success');
    }
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && !auth()->user()->hasVerifiedEmail())
                            <div
                                class="mt-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 p-4 border-l-4 border-amber-500">
                                <div class="flex gap-3">
                                    <svg class="h-5 w-5 text-amber-600 dark:text-amber-500 shrink-0 mt-0.5"
                            ...
                            @if (session('status') === 'verification-link-sent')
                                <div
                                    class="mt-3 rounded-xl bg-green-50 dark:bg-green-900/20 p-4 border-l-4 border-green-500">
                                    <div class="flex gap-3">
                                        <svg class="h-5 w-5 text-green-600 dark:text-green-500 shrink-0" fill="none"
