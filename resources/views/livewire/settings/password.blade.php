...
new class extends Component {
    ...
    public function updatePassword(): void
    {
        try {
            ...
            $this->dispatch('password-updated', message: 'Password saat ini tidak sesuai!', type: 'error');
        ...
        $this->dispatch('password-updated', message: 'Password berhasil diperbarui!', type: 'success');
    }
}; ?>
            ...
            <form method="POST" wire:submit="updatePassword" class="space-y-6">
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="relative">
                            <flux:input wire:model="current_password" type="password" required
