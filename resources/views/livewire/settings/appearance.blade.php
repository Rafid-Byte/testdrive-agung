...
<section class="w-full max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <div
            class="mt-6 h-px bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700">
        </div>
    </div>
    ...
    <div
        ...
        <div class="p-8">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Sesuaikan tampilan interface sesuai preferensi Anda
                </p>
            </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4" id="theme-switcher">
                        ...
                        <button type="button" data-theme="light"
                            ...
                            <div class="flex flex-col items-center gap-3">
                                <div
                                    class="p-3 rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 group-hover:scale-110 transition-transform">
                                ...
                                <div class="text-center">
                                    <span
                                        class="text-base font-bold text-gray-900 dark:text-zinc-100 block">Light</span>
                        ...
                        <button type="button" data-theme="dark"
                            ...
                            <div class="flex flex-col items-center gap-3">
                                <div
                                    class="p-3 rounded-full bg-gradient-to-br from-indigo-600 to-purple-600 group-hover:scale-110 transition-transform">
                                    <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="text-center">
                                    <span
                                        class="text-base font-bold text-gray-900 dark:text-zinc-100 block">Dark</span>
                        ...
                        <button type="button" data-theme="system"
                            ...
                            <div class="flex flex-col items-center gap-3">
                                <div
                                    class="p-3 rounded-full bg-gradient-to-br from-gray-600 to-gray-800 group-hover:scale-110 transition-transform">
                                    <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="text-center">
                                    <span
                                        class="text-base font-bold text-gray-900 dark:text-zinc-100 block">System</span>
                ...
                <div class="rounded-xl bg-blue-50 dark:bg-blue-900/20 p-4 border-l-4 border-blue-500">
                    <div class="flex gap-3">
                        <svg class="h-5 w-5 text-blue-600 dark:text-blue-400 shrink-0 mt-0.5" fill="none"
    ...
    <script>
        (function() {
            ...
            function applyTheme(theme) {
                ...
                const shouldBeDark = theme === 'dark' || (theme === 'system' && window.matchMedia(
                ...
                window.dispatchEvent(new StorageEvent('storage', {
                    key: 'darkMode',
                    newValue: shouldBeDark.toString()
                }));
                ...
                buttons.forEach(btn => {
                    ...
                    if (btn.dataset.theme === theme) {
                        btn.classList.add('ring-2', 'ring-blue-500', 'border-blue-500', 'bg-blue-50',
                            'dark:bg-blue-900/30');
                        if (checkmark) checkmark.classList.remove('hidden');
                    } else {
                        btn.classList.remove('ring-2', 'ring-blue-500', 'border-blue-500', 'bg-blue-50',
                            'dark:bg-blue-900/30');
