                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="text-sm font-medium text-gray-500 dark:text-gray-400">No.
                                Telepon</label>
                            <p class="text-gray-900 dark:text-white" x-text="selectedBooking.nomor_telepon || '-'"></p>
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="text-sm font-medium text-gray-500 dark:text-gray-400">Target
                                Prospect</label>
                            <p class="text-gray-900 dark:text-white" x-text="selectedBooking.target_prospect || '-'">
                            </p>
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-500 dark:text-gray-400">Tanggal
                                Acara</label>
                            <p class="text-gray-900 dark:text-white" x-text="selectedBooking.tanggal_acara || '-'"></p>
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-500 dark:text-gray-400">Tanggal
                                Mulai</label>
                            <p class="text-gray-900 dark:text-white" x-text="selectedBooking.tanggal_mulai || '-'"></p>
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-500 dark:text-gray-400">Tanggal
                                Selesai</label>
                            <p class="text-gray-900 dark:text-white" x-text="selectedBooking.tanggal_selesai || '-'">
                            </p>
                        </div>
                        <div class="col-span-1 lg:col-span-2">
                            <label class="text-sm font-medium text-gray-500 dark:text-gray-400">Lokasi
                                Acara</label>
                            <p class="text-gray-900 dark:text-white" x-text="selectedBooking.lokasi_acara || '-'"></p>
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-500 dark:text-gray-400">Supervisor</label>
                            <p class="text-gray-900 dark:text-white" x-text="selectedBooking.supervisor_name || '-'">
                            </p>
                        </div>
                        <div>
