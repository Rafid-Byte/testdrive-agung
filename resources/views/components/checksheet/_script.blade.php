<script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('checkSheetSecurity', () => ({
                    ...
                    init() {
                        // Baca dari 'theme' (appearance page) atau fallback ke 'darkMode' (toggle lama)
                        ...
                        // Dengarkan perubahan dari tab/halaman lain (termasuk appearance page)
                    ...
                    get filteredBookings() {
                        ...
                        if (this.dateFilter) {
                            // Bandingkan langsung ISO string — tidak perlu parsing, tidak ada timezone issue
                        ...
                        if (this.dateSort) {
                            ...
                            filtered = [...filtered].sort((a, b) => {
                                const comparison = (a.date_raw || '').localeCompare(b.date_raw || '');
                    ...
                    async updateCarStatus(booking, newStatus) {
                        ...
                        try {
                            ...
                            if (response.ok && data.success) {
                                ...
                                // Sync status_mobil ke checksheet jika booking punya checksheet
                                if (booking.has_checksheet) {
                                    await fetch(`/checksheet/booking/${booking.id}/status-mobil`, {
                                        ...
                                        body: JSON.stringify({ status_mobil: newStatus })
                                    });
                                }
